...
#3. Simulate a pair of dice by creating a random object and passing it 1 & 7. (i.e random.Next(1,7)) NOTE: random.Next is not inclusive meaning that if you pass it 1 and 7 it will generate a 'random' number between one and six.
