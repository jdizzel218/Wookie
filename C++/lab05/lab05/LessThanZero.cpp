...
// Description: LessThanZero Exception Implementation
...
// -----------------------------------------------------------------
LessThanZeroError::LessThanZeroError()
{
...
// Post-conditions: None
// -----------------------------------------------------------------
LessThanZeroError::LessThanZeroError(string reason, int value) {
...
// Post-conditions: None
// -----------------------------------------------------------------
string LessThanZeroError::getReason() const {return _reason;}
...
// Post-conditions: None
// -----------------------------------------------------------------
int LessThanZeroError::getValue() const { return _value; }